...
namespace Starwars
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var opg1 = planets.Where(x => x.Name.FirstOrDefault() == 'M');
            //foreach (var item in opg1)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg2 = planets.Where(x => x.Name.Contains('y') || x.Name.Contains('Y'));
            //foreach (var item in opg2)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg3 = planets.Where(x => x.Name.Length > 9 && x.Name.Length < 15);
            //foreach (var item in opg3)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg4 = planets.Where(x => x.Name[1] == 'a' && x.Name.LastOrDefault() == 'e');
            //foreach (var item in opg4)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg5 = planets.Where(x => x.RotationPeriod > 40).OrderBy(o => o.RotationPeriod);
            //foreach (var item in opg5)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg6 = planets.Where(x => x.RotationPeriod > 10 && x.RotationPeriod < 20).OrderBy(n => n.Name);
            //foreach (var item in opg6)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg7 = planets.Where(x => x.RotationPeriod > 30).OrderBy(c => c.Name).ThenBy(c => c.RotationPeriod);
            //foreach (var item in opg7)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg8 = planets.Where(x => (x.RotationPeriod < 30 || x.SurfaceWater > 50) && x.Name.Contains("ba")).OrderBy(c => c.Name).ThenBy(c => c.SurfaceWater).ThenBy(c => c.RotationPeriod);
            //foreach (var item in opg8)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg9 = planets.Where(x => x.SurfaceWater > 0).OrderByDescending(o => o.SurfaceWater);
            //foreach (var item in opg9)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg10 = planets.Where(x => x.Diameter > 0 && x.Population > 0).OrderBy(x => ((4 * 3.14 * Math.Pow(x.Diameter, 2)) / x.Population));
            //foreach (var item in opg10)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var planets2 = planets.Where(x => x.RotationPeriod > 0);
            //var opg11 = planets.Except(planets2);
            //foreach (var item in opg11)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg12p1 = planets.Where(x => x.Name.ToLower().StartsWith("a") || x.Name.ToLower().EndsWith("s"));
            //var opg12p2 = planets.Where(x => x.Terrain != null && x.Terrain.Any(n => n.Contains("rainforests")));
            //var allopg12 = opg12p1.Union(opg12p2);
            //foreach (var item in allopg12)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg13 = planets.Where(x => x.Terrain != null && x.Terrain.Any(n => n.Contains("desert")));
            //foreach (var item in opg13)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg14 = planets.Where(x => x.Terrain != null && x.Terrain.Any(n => n.Contains("swamp"))).OrderBy(x => x.RotationPeriod).ThenBy(x => x.Name);
            ...
            //string[] tripleVowels = { "aaa", "eee", "iii", "ooo", "uuu", "yyy" };

            //var opg15 = planets.Where(p => doubleVowels.Any(p.Name.Contains) && !tripleVowels.Any(p.Name.Contains));
            //foreach (var item in opg15)
            //{
            //    Console.WriteLine(item.Name);
            //}

            //var opg16 = planets.Where(x => x.Name.Contains("kk") || x.Name.Contains("ll") || x.Name.Contains("rr") || x.Name.Contains("nn")).OrderByDescending(x => x.Name);
